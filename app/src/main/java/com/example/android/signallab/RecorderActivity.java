...
public class RecorderActivity extends AppCompatActivity {
    ...
    private void onFrameReady(short[] audioBuffer) {
        //applying EQ filters, generating FFT/waveform for visualisation, output
    }
    ...
    private void stopRecording () {
        ...
        //currently disabled because audio is processed directly from buffers
        //not sure if we will be saving raw recordings
